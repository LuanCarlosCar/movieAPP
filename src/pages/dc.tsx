...
export async function getStaticProps(){
  ...
  const response = await fetch('https://api.themoviedb.org/4/list/3?api_key=4e9cbdb6188d564ab3062e486d67953a')
  const response2 = await fetch('https://api.themoviedb.org/4/list/10?api_key=4e9cbdb6188d564ab3062e486d67953a')
